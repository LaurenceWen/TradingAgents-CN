...
**用户反馈**：
> "使用旧版引擎生成的报告，投资组合经理和最终投资决策的结果是一样的。应该是我们最后一步生成最终投资决策的结果没有被调用或者是空值。"
...
- `final_trade_decision`: `🎯 最终交易决策` → `🎯 最终投资决策`
...
在报告详情页面查看：
- `💡 初步投资建议` 和 `🎯 最终投资决策` 的内容应该不同
- 最终投资决策应该更详细，包含风险控制措施
- 报告按照流程顺序展示
